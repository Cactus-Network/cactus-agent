...
/**
 * The actual definition of `Spend` type was moved to https://github.com/Cactus-Network/cactus_rs/blob/main/wheel/src/run_generator.rs
 * from cactus-blockchain@1.5.1
 */
export type Spend = {
  coin_id: bytes32
  puzzle_hash: bytes32
...
/**
 * The actual definition of `SpendBundleConditions` type was moved to https://github.com/Cactus-Network/cactus_rs/blob/main/wheel/src/run_generator.rs
 * from cactus-blockchain@1.5.1
 */
